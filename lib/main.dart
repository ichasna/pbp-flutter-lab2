...
class CounterApplication extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CounterScreenState(title: 'Flutter Demo Home Page'),
    );
  }
}

class CounterScreenState extends StatefulWidget {
  const CounterScreenState({key, required this.title});
  ...
  @override
  State<CounterScreenState> createState() => CounterScreen();
}
